...
namespace BezvizSystem.BLL.Tests
{
    ...
    public class ReportTest
    {
        ...
        {       
            ...
            Assert.IsTrue(r.AllRegistrated == "2");
            Assert.IsTrue(r.AllArrived == "2");
            Assert.IsTrue(r.WaitArrived == "0");
            Assert.IsTrue(r.NotArriverd == "0");
            Assert.IsTrue(r.AllTourist == "0");
            Assert.IsTrue(r.AllGroup == "1");
            Assert.IsTrue(r.AllTouristInGroup == "2");

            r = report.GetReport(DateTime.Parse("01.06.2016"), DateTime.Parse("30.07.2018"), DateTime.Parse("21.07.2018"));
